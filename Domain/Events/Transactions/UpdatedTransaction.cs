...
namespace Domain.Events.Transactions
{
    public record UpdatedTransaction : DomainEvent
    {
        ...
        public bool WasTransference { get; private set; }
        public bool IsTransference { get; private set; }

        public UpdatedTransaction(Guid oldAccount, Guid newAccount, decimal oldAmmount, decimal newAmmount, TransactionType oldType, TransactionType newType, bool wasTransference, bool isTransference) : base(DateTime.Now)
        {
            ...
            OldType = oldType;
            NewType = newType;
            WasTransference = wasTransference;
